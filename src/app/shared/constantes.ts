...
export const PATH_HOGAR_VINCULADAS = PATH_SERVER_BACK + PATH_POLIZAS + '/hogar/vinculadas';
export const PATH_HOGAR_VINCULAR_DOCUMENTO = PATH_SERVER_BACK + PATH_POLIZAS + '/hogar';
export const PATH_HOGAR_ELIMINAR = PATH_SERVER_BACK + PATH_POLIZAS + '/hogar/eliminar';
