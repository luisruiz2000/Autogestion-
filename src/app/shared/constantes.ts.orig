...
export const PATH_SERVICIO_DOMINIOS_MUNICIPIOS =
  'api/v1/valorDominio/get/flag/';
...
export const PATH_ACTUALIZAR_USUARIO =
  PATH_SERVER_BACK + PATH_USUARIO_CONTROLLER + '/actualizar';

export const PATH_PARAMETROS = 'api/parametros';
export const PATH_CONSULTAR_CHAT =
  PATH_SERVER_BACK + PATH_PARAMETROS + '/URL_CHAT';
export const PATH_OFICINAS_ADMIN =
  PATH_SERVER_BACK + PATH_PARAMETROS + '/OFICINAS_ADMIN_TALLER';

export const PATH_LOGIN =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/login';

export const PATH_REFRESH_TOKEN =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/refreshtoken';

export const PATH_LOGOUT =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/logout';

export const PATH_REGISTRO_USUARIO =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/registrarUsuario';
export const PATH_RIESGOS_ASOCIADOS =
  PATH_SERVER_BACK + PATH_POLIZAS + '/asociarRiesgos';

// Constante para la url de dominios
export const PATH_DOMINIOS = PATH_SERVER_BACK + PATH_SERVICIO_DOMINIOS;
export const PATH_DOMINIOS_MUNICIPIOS =
  PATH_SERVER_BACK + PATH_SERVICIO_DOMINIOS_MUNICIPIOS;

export const PATH_TYC = PATH_SERVER_BACK + PATH_TOOLTIPS + '/tyc';

export const PATH_SOLICITAR_CAMBIO =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/solicitarCambioContrasena';

export const PATH_COMPARAR_CADENA =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/compararCadenaWeb';

export const PATH_RECUPERAR_CONTRASENA =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/recuperarContrasena';

export const PATH_VALIDAR_REGISTRO =
  PATH_SERVER_BACK + PATH_SERVICIO_AUTENTICACION + '/validarRegistro';

export const PATH_GET_VEHICULOS =
  environment.urlGetVehiculos + 'api/poliza/vehiculo/getvehiculos'; //PATH_SERVER_BACK + PATH_VEHICULOS + '/getvehiculos';

export const PATH_REGISTRAR_PLACA =
  PATH_SERVER_BACK + PATH_VEHICULOS + '/registrarPlaca';

export const PATH_ELIMINAR_VEHICULO =
  PATH_SERVER_BACK + PATH_VEHICULOS + '/eliminarVehiculo';
...
export const PATH_CIUDADES_SEGMENTO =
  PATH_SERVER_BACK + 'api/taller/ciudadesSegmento';
export const PATH_TIPO_VEHICULO =
  PATH_SERVER_BACK + 'api/taller/getTiposVeh/pesados';
export const PATH_TALLERES_SEGMENTO =
  PATH_SERVER_BACK + 'api/taller/talleresSegmento';

export const PATH_TALLERES = PATH_SERVER_BACK + 'api/taller';
export const PATH_GESTION_MARCA = PATH_SERVER_BACK + 'api/gestionmarcas';

export const PATH_RADICAR_SINIESTRO =
  PATH_SERVER_BACK + 'api/siniestro/registrarContacta';
export const PATH_OBTENER_SINIESTROS =
  PATH_SERVER_BACK + 'api/siniestro/getSiniestros';
export const PATH_SINIESTRO_DATOS_BASICOS =
  PATH_SERVER_BACK + 'api/siniestro/datosBasicos';
export const PATH_SINIESTRO_CARGAR_EVIDENCIA =
  PATH_SERVER_BACK + 'api/siniestro/evidenciaWeb';
...
export const PATH_GET_LINK_VIDEO_PERITACION =
  PATH_SERVER_BACK + 'api/videoPeritacion';
...
export const PATH_TOOLTIPS_NOAUTH =
  PATH_SERVER_BACK + PATH_TOOLTIPS + '/getTooltipNoAutenticado';

// Constantes con los patrones de validación
// Patron de validación del correo electrónico
export const CORREO_PATTERN =
  /^[a-zA-Z0-9]+[_\w\.\-]*[a-zA-Z0-9]+@[a-zA-Z0-9][_\w\.\-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*$/;
...
export const URL_PQR =
  'https://web.millenium.com.co/millenuevoprevisora/pages/pqrwebpage.jsp?fuente=PPAL';
export const URL_GOOGLEPLAY =
  'https://play.google.com/store/apps/details?id=com.asesoftware.previsora.autogestion';
export const URL_APPSTORE =
  'https://apps.apple.com/co/app/la-previsora-seguros/id1515617326';
...
export const ICONO_PERFILx3 = 'assets/images/ico_usuario_perfil@3x.jpeg';
...
export const ICO_SUPER_INTENDENCIA =
  'assets/images/logo-superintendencia-financiera.svg';
...
export const ICO_LLAMAR_345 = 'assets/images/ico-llamar345.svg';
export const ICO_LLAMAR_345_PNG = 'assets/images/ico-345.png';
...
export const ICO_INTERROGACION_GRIS =
  'assets/images/icono-interrogacion-gris.png';
export const ICO_INTERROGACION_VERDE =
  'assets/images/icono-interrogacion-verde.png';
export const ICO_INTERROGACION_VERDE_SIDE_BAR =
  'assets/images/preguntas-side-bar.svg';
...
export const ICO_AVANCE_INICIO_GRIS =
  'assets/images/ico-avance-inicio-gris.png';
export const ICO_AVANCE_REPUESTOS_GRIS =
  'assets/images/ico-avance-repuestos-gris.png';
export const ICO_AVANCE_LATONERIA_GRIS =
  'assets/images/ico-avance-latoneria-gris.png';
export const ICO_AVANCE_PINTURA_GRIS =
  'assets/images/ico-avance-pintura-gris.png';
export const ICO_AVANCE_FINALIZADO_GRIS =
  'assets/images/ico-avance-finalizado-gris.png';
export const ICO_AVANCE_ENTREGADO_GRIS =
  'assets/images/ico-avance-entregado-gris.png';
export const ICO_AVANCE_INICIO_VERDE =
  'assets/images/ico-avance-inicio-verde.png';
export const ICO_AVANCE_REPUESTOS_VERDE =
  'assets/images/ico-avance-repuestos-verde.png';
export const ICO_AVANCE_LATONERIA_VERDE =
  'assets/images/ico-avance-latoneria-verde.png';
export const ICO_AVANCE_PINTURA_VERDE =
  'assets/images/ico-avance-pintura-verde.png';
export const ICO_AVANCE_FINALIZADO_VERDE =
  'assets/images/ico-avance-finalizado-verde.png';
export const ICO_AVANCE_ENTREGADO_VERDE =
  'assets/images/ico-avance-entregado-verde.png';
...
export const ICO_FASE_REPUESTOS_GRIS =
  'assets/images/ico-fase-repuestos-gris.png';
export const ICO_FASE_LATONERIA_GRIS =
  'assets/images/ico-fase-latoneria-gris.png';
export const ICO_FASE_PINTURA_GRIS = 'assets/images/ico-fase-pintura-gris.png';
export const ICO_FASE_FINALIZADO_GRIS =
  'assets/images/ico-fase-finalizado-gris.png';
export const ICO_FASE_ENTREGADO_GRIS =
  'assets/images/ico-fase-entregado-gris.png';
export const ICO_FASE_INICIO_VERDE = 'assets/images/ico-fase-inicio-verde.png';
export const ICO_FASE_REPUESTOS_VERDE =
  'assets/images/ico-fase-repuestos-verde.png';
export const ICO_FASE_LATONERIA_VERDE =
  'assets/images/ico-fase-latoneria-verde.png';
export const ICO_FASE_PINTURA_VERDE =
  'assets/images/ico-fase-pintura-verde.png';
export const ICO_FASE_FINALIZADO_VERDE =
  'assets/images/ico-fase-finalizado-verde.png';
export const ICO_FASE_ENTREGADO_VERDE =
  'assets/images/ico-fase-entregado-verde.png';
export const IMAGEN_FASE_A = 'assets/images/imagen_a.png';
export const IMAGEN_FASE_B = 'assets/images/imagen_fase_b.png';
export const ICO_CALENDARIO_ENTREGADO =
  'assets/images/ico-calendario-entregado.png';
export const ICO_HERRAMIENTA_TALLER =
  'assets/images/ico-herramienta-taller.svg';
...
export const ICO_CONFIGURACION_VERDE =
  'assets/images/ico_configuracion_verde.svg';
...
export const CAPTCHA_SITE_KEY_PREVISORA =
  '6Lc9ZDApAAAAAKIxtIYY44nB0kgr3nVsTF5Z2v_g';
//export const CAPTCHA_SITE_KEY_PREVISORA = '6LeMflwpAAAAAHS31x7iubMNxjXkaORFFfPviZ_c';

export const CAPTCHA_PRIVATE_KEY_PREVISORA =
  '6LeYAC0pAAAAAKz1yrYTL7kMCp3NSMC116ZckS1n';

// Constantes Re-Captcha Felipe García
export const CAPTCHA_SITE_KEY_DEVELOPER =
  '6LdSg9oUAAAAAH1A-qfYm2EE-aFrhM5zrbw2y0an';
export const CAPTCHA_PRIVATE_KEY_DEVELOPER =
  '6LdSg9oUAAAAANa9k_H7yDgbDSZwAEgUh1UBRlz8';
...
=======
export const ICO_FASE_AGENDAR_CITA_VERDE =
  'assets/images/ico_agendar_cita_verde.png';
export const ICO_FASE_CONFIRMACION_VERDE =
  'assets/images/ico_confirmacion_verde.png';
export const ICO_FASE_DATOS_CORREO_VERDE =
  'assets/images/ico_datos_correo_verde.png';
export const ICO_FASE_INGRESAR_LINK_VERDE =
  'assets/images/ico_ingresar_link_verde.png';
export const ICO_FASE_VIDEO_PERITACION_VERDE =
  'assets/images/ico_video_peritacion_verde.png';
export const ICO_FASE_FINALIZACION_VERDE =
  'assets/images/ico_finalizacion_verde.png';
export const ICO_MENU_VIDEO_PERITACION_VERDE =
  'assets/images/ico_menu_video_peritacion_verde.png';
export const ICO_MENU_VIDEO_PERITACION_BLANCO =
  'assets/images/ico_menu_video_peritacion_blanco.svg';
export const ICO_LLAMAR_345_VIDEO_PERITACION =
  'assets/images/btn_llamar_sin_fondo.png';
>>>>>>> feature/preguntas
